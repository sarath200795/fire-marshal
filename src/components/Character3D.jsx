...
// Flat-cartoon "Sam" — a friendly fire-safety officer: yellow hard hat, white
// shirt, coral/red hi-vis vest, dark trousers, holding a glowing red safety
// baton (a rolled checklist in the other hand). Built from primitives and
// procedurally animated per state. Big-head chibi proportions so it reads
// clearly at small sizes; camera framed so the whole figure is always visible.
const SKIN = '#f3c9a3', SKIN_D = '#e0ad82'
const HAT = '#f4c20d', HAT_D = '#d4a200'             // yellow hard hat
const SHIRT = '#ffffff', SLEEVE_D = '#e8edf3'        // white shirt sleeves
const VEST = '#f73838', VEST_D = '#bd1414', STRIPE = '#fde68a' // coral hi-vis vest + reflective stripes
...
function Rig({ mode = 'idle', facing = 1 }) {
  ...
  return (
    <group ref={root}>
      ...
      {/* right arm — free hand / pen in write mode, glowing red safety baton otherwise */}
